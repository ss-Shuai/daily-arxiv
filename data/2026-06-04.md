...
TL;DR: A probabilistic framework integrating small-scale spatial heterogeneity into macroscopic material behavior models for polycrystals using physics-informed neural networks to solve Liouville equations.


<details>
  <summary>Details</summary>
Motivation: Traditional macroscopic material models fail to capture small-scale spatial heterogeneity in polycrystalline metals, limiting prediction accuracy for microstructural variability across different material realizations.

Method: Developed SPLIT-PINN method combining probability density functions, Liouville equation with unknown drift term, marginal-correction drift decomposition, orthogonality constraints, and residual-based adaptive training for inverse identification.

Result: Framework successfully infers drift fields from data, enables accurate forward predictions of joint and marginal PDFs for von Mises stress, dislocation density, and equivalent plastic strain rate across multiple unseen polycrystal realizations.

Conclusion: The proposed SPLIT-PINN framework provides accurate, robust, and generalizable probabilistic predictions of polycrystalline microstructural evolution without requiring restrictive parametric assumptions.
...
### [2] [Uncertainty-Aware Symbolic Regression through Bayesian Support Selection](https://arxiv.org/abs/2606.04042)
...
### [3] [High-density, high-mobility ultrathin spin-polarized two-dimensional electron gas at the polar/polar LaVO$_3$/KTaO$_3$ interface: Insights from first-principles calculations](https://arxiv.org/abs/2606.04252)
*Arpan Das*

Main category: cond-mat.mtrl-sci

TL;DR: This study investigates the formation mechanism of a high-mobility two-dimensional electron gas (2DEG) at the interface between KTaO3 (KTO) and LaVO3 (LVO) using first-principles DFT calculations. Both bulk materials are insulating, yet the interface develops robust metallicity due to polar discontinuity-driven electronic reconstruction.


<details>
  <summary>Details</summary>
Motivation: The researchers aim to understand the microscopic origin of 2DEG formation at oxide interfaces and explore its potential for quantum electronics applications, particularly focusing on how polar catastrophe is avoided through charge transfer mechanisms.

Method: First-principles density functional theory (DFT) calculations were employed to investigate the electronic structure and properties of the LVO/KTO heterostructure, analyzing charge redistribution, orbital character, and band structures.

Result: The study reveals that electrons transfer from outer surfaces toward the interface to avoid polar catastrophe, resulting in hole accumulation in the surface VO2 layer and electron accumulation in the interfacial TaO2 layer. This creates a highly confined, spin-polarized 2DEG with predominantly Ta 5dxy orbital character. The spin-up parabolic band shows exceptionally small effective mass (lower than LaAlO3/SrTiO3) and approximately ten times higher electron density than the prototypical system.

Conclusion: The LVO/KTO heterostructure represents a promising platform for high-density, high-mobility spin-polarized 2DEGs and offers potential for engineering correlated oxide interfaces in quantum electronic applications.
...
### [4] [Mechanical bistability and hysteresis in graphene-CNT hybrid systems: from atomistic simulations to macroscale structural responses](https://arxiv.org/abs/2606.04504)
...
TL;DR: This study investigates the structural stability and mechanical behavior of graphene-carbon nanotube (Gr-CNT) hybrid systems through molecular dynamics simulations and nanoindentation experiments. The research reveals that under certain conditions, these hybrid structures exhibit mechanical bistability with two stable states (adhesion and separation of graphene layers), arising from competition between van der Waals attraction and elastic deformation.


<details>
  <summary>Details</summary>
Motivation: Hybrid systems composed of graphene and carbon nanotubes have broad applications in electronics, mechanics, energy, and environmental science. Since microstructures strongly affect properties, it is essential to establish mechanical principles governing these hybrid structures to design better materials.

Method: Molecular dynamics simulations of stacked Gr-CNT structures (two graphene layers confining CNTs), combined with nanoindentation experiments on fabricated rGO-CNT hybrid films using atomic force microscopy.

Result: The study identified energetically stable configurations governed by intertube spacing, CNT diameter, and wall number. Under certain conditions, structures exhibit mechanical bistability with adhesion and separation states of graphene layers. Both simulations and experiments show hysteresis and energy dissipation, with experimental results showing higher dissipation energy compared with pure rGO.

Conclusion: The findings provide valuable insights into Gr-CNT hybrid systems and offer guidance for designing microstructures with enhanced properties for advanced applications in electronics, mechanics, energy, and environmental fields.
...
### [5] [Why Fe doping kills photoluminescence in CsPbCl$_3$ but not in CsPbBr$_3$: Role of midgap Fe 3$d$ states and electron-phonon coupling](https://arxiv.org/abs/2606.04714)
...
TL;DR: A numerical study investigating metallic hydrogen using restricted path integral Monte Carlo methods, examining a quantum two-component plasma of electrons and protons to understand the phase transition from metallic to molecular hydrogen.


<details>
  <summary>Details</summary>
Motivation: To understand the thermodynamic and structural properties of metallic hydrogen and investigate the phase transition from metallic to molecular hydrogen phases as temperature changes.

Method: Restricted path integral Monte Carlo simulations from first principles on a quantum two-component plasma system, treating electrons as point particles with negative unit charge and protons as positively charged hard spheres. Both additive and nonadditive mixtures were studied, with focus on 1:1 electron-proton ratio.

Result: A phase transition from metallic hydrogen to molecular hydrogen was observed as temperature decreased. Correlations were found to diminish at high densities.

Conclusion: The study confirms the temperature-driven phase transition behavior in metallic hydrogen systems, with reduced electronic correlations at high compression.
...
### [7] [Curvature-driven revival of charge density waves in non-Euclidean space](https://arxiv.org/abs/2606.04728)
...
TL;DR: This study investigates whether geometric curvature in 2D materials can revive charge density wave (CDW) order that has been suppressed by electronic perturbations. By constructing TiSe₂-NbSe₂ heterostructures on curved substrates, researchers discovered that while flat regions show complete CDW suppression due to charge transfer, a novel CDW state survives in morphologically distorted non-Euclidean nanoscale regions.


<details>
  <summary>Details</summary>
Motivation: The core question explores whether non-Euclidean geometric deformations can compete with extreme electronic perturbations (like heavy carrier doping) to reshape or revive a quenched macroscopic quantum order. CDWs are typically quenched by such perturbations, so finding a mechanism to revive them through curvature represents a paradigm shift.

Method: Researchers constructed monolayer TiSe₂-NbSe₂ heterostructures on BLG/SiC substrates and employed low-temperature ARPES to measure Fermi surface topology and interfacial charge transfer. High-resolution STM was used to image nanoscale curved regions directly. Atomistic simulations were performed to understand the structural origins of the phenomenon.

Result: ARPES revealed massive interfacial charge transfer that destroys global Fermi surface nesting and completely suppresses long-range CDW order in Euclidean flat regions. However, STM uncovered a novel, non-linear CDW state that remains strictly localized within morphologically distorted non-Euclidean nanoscale curved regions. Simulations showed that interfacial twist and lattice mismatch spontaneously generate a corrugated superlattice that enables this curvature-stabilized CDW.

Conclusion: Geometric curvature serves as an independent structural degree of freedom capable of reviving frustrated quantum orders that are destroyed in flat geometries. This demonstrates that non-Euclidean deformations can compete with extreme electronic perturbations, opening new avenues for controlling strongly correlated quantum states through engineered geometry.
...
### [8] [Machine learning via artificial neural networks coupled with density functional theory and experiments for thermodynamic optimization of high-entropy alloys for hydrogen storage at room temperature](https://arxiv.org/abs/2606.04803)
*Shivam Dangwal,Pranav Kumar,Yuji Ikeda,Blazej Grabowski,Kaveh Edalati*

Main category: cond-mat.mtrl-sci

TL;DR: Machine learning (ANN) combined with DFT to design Ti-Nb-V-Cr-Mn-Fe high-entropy alloys for room-temperature hydrogen storage, with experimental validation confirming reversible hydrogen uptake.


<details>
  <summary>Details</summary>
Motivation: High-entropy alloys show promise for hydrogen storage due to compositional flexibility, but achieving optimal thermodynamics for ambient temperature applications remains challenging.

Method: Used artificial neural networks (ANN) and density functional theory (DFT) to predict hydride formation enthalpies for AB-type Ti(x)Nb(2-x)VCrMnFe system (x = 0.5-2.0), followed by experimental validation.

Result: Hydride formation enthalpy decreases to negative values with increasing titanium content. Alloys with x > 1.5 achieve enthalpies in the -25 to -39 kJ/mol range, suitable for room-temperature hydrogen storage. Experimental results confirm predictions with reversible hydrogen storage and fast kinetics.

Conclusion: The integrated approach of machine learning and ab initio calculations provides a reliable framework for exploring high-entropy hydrides as practical hydrogen storage materials.
...
### [9] [Variational approach to determine the properties of dislocations at finite deformation](https://arxiv.org/abs/2606.04862)
*István Groma*

Main category: cond-mat.mtrl-sci

TL;DR: This paper extends dislocation continuum theory from small deformation to finite deformation frameworks, showing the Peach-Koehler force fails for large deformations.


<details>
  <summary>Details</summary>
Motivation: Previous continuum theory of curved dislocations only worked for small deformations; this research aims to establish fundamentals of elasticity theory with individual dislocations under finite deformations.

Method: Equilibrium equations were derived within a variational formalism approach.

Result: Introducing dislocations into finite deformation framework is nontrivial. Importantly, for large deformations, the classic Peach-Koehler force does not apply to dislocation segments.

Conclusion: The findings lay groundwork for generalizing the dislocation continuum theory of curved dislocations to handle large deformation scenarios.
...
### [10] [Probing pairing symmetries through quasiparticle interference in chiral Bloch bands](https://arxiv.org/abs/2606.04097)
*Sayan Banerjee,Subrata Mandal,Peter P. Orth,Mathias S. Scheurer*

Main category: cond-mat.supr-con

TL;DR: Theory for quasiparticle interference (QPI) in superconductors with chiral Bloch bands, revealing how quantum geometry affects interference patterns and can distinguish candidate pairing states.


<details>
  <summary>Details</summary>
Motivation: Recent experiments show superconductivity emerges from chiral normal states in van der Waals multi-layer systems, but lacking theoretical framework for QPI in such chiral superconductors.

Method: Theoretical analysis of quasiparticle interference in systems with chiral Bloch bands, examining quantum geometry effects on interference patterns in both normal and superconducting states.

Result: Non-trivial quantum geometry of Bloch states significantly affects interference patterns in the normal state with sublattice dependence. In superconducting state, interplay of quantum geometry of Bogoliubov quasiparticles with momentum-dependent order parameter phase creates complex behavior. Spatial dependence of local spectral function around impurities can distinguish between different candidate pairing states including zero and finite center-of-mass momentum.

Conclusion: Provides theoretical framework for interpreting QPI patterns in materials with chiral bands, useful for probing pairing physics in van der Waals multi-layer systems like twisted bilayer graphene.
...
### [11] [Antiferromagnetic Quantum Criticality in Infinite-Layer Cuprates Sr1-xNdxCuO2](https://arxiv.org/abs/2606.04559)
...
TL;DR: This study investigates quantum criticality and Fermi surface reconstruction in electron-doped infinite-layer cuprate Sr1-xNdxCuO2 thin films synthesized via ozone-assisted molecular beam epitaxy. Using Hall transport measurements, researchers identified a carrier-type transition at critical doping xc ~ 0.155, consistent with a spin-density-wave model suggesting antiferromagnetic quantum criticality. The normal state exhibits pristine strange metal behavior near this quantum critical point.


<details>
  <summary>Details</summary>
Motivation: The phase diagram of high-temperature cuprate superconductors involves complex interplay between quantum criticality and Fermi surface reconstruction. While electron-doped T'-structure cuprates suggested an antiferromagnetic origin, quantitative consensus was hindered by experimental challenges like apical oxygen instabilities and uncontrolled oxygen vacancies. This study aimed to establish a definitive understanding using cleaner material systems.

Method: High-quality, oxygen-stoichiometric thin films of infinite-layer cuprate Sr1-xNdxCuO2 were synthesized across the entire superconducting dome using ozone-assisted molecular beam epitaxy. Hall transport measurements were performed to characterize carrier behavior, and experimental data were compared with predictions from a spin-density-wave tight-binding model.

Result: Hall transport measurements revealed a sharp carrier-type transition signaling Fermi surface reconstruction at critical doping xc ~ 0.155. The spin-density-wave tight-binding model quantitatively reproduced the transport evolution, supporting an antiferromagnetic origin of the quantum phase transition. Upon suppressing superconductivity with magnetic fields, the normal-state resistivity exhibited pristine strange metal behavior persisting down to 2 K near xc.

Conclusion: The findings establish an intrinsic, universal antiferromagnetic quantum criticality in electron-doped cuprates. The structurally simplest infinite-layer cuprates serve as a clean benchmark platform for theories of unconventional superconductivity, providing a foundation for understanding quantum critical mechanisms in high-Tc cuprate systems.
...
TL;DR: This study investigates the competition between charge-density-wave (CDW) order and superconductivity in monolayer W2N and halogen-functionalized variants (W2NF2 and W2NCl2) using first-principles calculations. The research reveals that CDW and superconductivity emerge as competing outcomes of the same electron-phonon coupling mechanism driven by softened phonons.


<details>
  <summary>Details</summary>
Motivation: Understanding the interplay between CDW order and superconductivity is a central problem in condensed-matter physics since both phenomena often arise from the same electron-phonon coupling mechanism. This work aims to clarify how these competing states can be tuned and controlled in novel materials.

Method: First-principles calculations were employed to investigate structural, electronic, vibrational, and superconducting properties of monolayer W2N, W2NF2, and W2NCl2 systems.

Result: Pristine W2N exhibits strong electron-phonon coupling leading to phonon instabilities near M and K points, with strong-coupling superconductivity (λ=1.00, Tc=13.2 K). Fluorination reduces the soft-phonon anomaly, yielding moderate-coupling superconductivity (λ=0.67, Tc=5.3 K). W2NCl2 shows re-emergence of CDW-related phonon softening that can be suppressed by compressive strain (-3%), reducing λ from 1.35 to 0.71 and achieving Tc=5.8 K. Across all materials, low-energy physics is governed by softened ZA phonons near the M point.

Conclusion: CDW order and superconductivity in the W2N family emerge as competing manifestations of the same soft-phonon-driven electron-phonon coupling mechanism, providing a unified framework for understanding and engineering these correlated electronic phases.
...
### [13] [Theory of frozen flux in a narrow uniform superconducting strip after cooling in a small magnetic field](https://arxiv.org/abs/2606.04961)
*Alexei E. Koshelev*

Main category: cond-mat.supr-con

TL;DR: Analysis of residual frozen magnetic flux in a superconducting strip cooled through its critical temperature in perpendicular magnetic field. The study derives a dynamic-balance equation to determine the freezing temperature and frozen vortex density, showing strong dependence on magnetic field and cooling rate.


<details>
  <summary>Details</summary>
Motivation: This research addresses the critical issue of trapped magnetic flux in superconducting electronic devices, which is a fundamental problem affecting device performance and reliability.

Method: The authors derive and solve a dynamic-balance equation for the process, considering the interplay between thermally-activated vortex entry/exit events and the geometrical energy barrier formed by strip edges and Meissner screening currents.

Result: The relative freezing temperature (1-T_fr/T_c) exceeds the fluctuation width by a large logarithmic factor, increases rapidly as the field approaches the minimum flux-expulsion field, and logarithmically increases with decreasing cooling rate. The frozen flux density shows strong magnetic-field dependence.

Conclusion: The findings provide quantitative predictions for T_fr and frozen vortex density, with results that can be used to define the effective flux-expulsion magnetic field. This work helps understand and control flux trapping in superconducting devices.
...
TL;DR: The paper analyzes stability of iterative solutions in parquet equations by studying the Jacobian spectrum of damped fixed-point iterations. It reveals that convergence issues in parquet calculations can occur even without vertex divergences, contrary to previous assumptions. A stabilization strategy is proposed and demonstrated in zero-point and Hubbard atomic limit models.


<details>
  <summary>Details</summary>
Motivation: To address misleading convergence issues observed in parquet calculations at intermediate-to-high interaction values, which were previously thought to be caused by vertex divergences associated with multi-valued Luttinger-Ward functional crossings.

Method: Systematic analysis of the stability of iterative solutions by studying the spectrum of the Jacobian associated with the commonly used damped fixed-point iteration procedure, providing an explicit criterion for determining when the physical fixed point becomes unstable.

Result: Demonstrated that convergence issues are not restricted to parameter regions with two-particle irreducible vertex divergences - they can also arise in absence of such divergences. Successfully stabilized the physical solution deep in the non-perturbative regime, even across multiple divergence lines, in both zero-point and Hubbard atomic limit models.

Conclusion: A controlled stabilization strategy was introduced that allows convergence to the physical solution in instability regimes, effectively resolving misleading convergence problems in parquet-based algorithms beyond the constraint of vertex divergence regions.
